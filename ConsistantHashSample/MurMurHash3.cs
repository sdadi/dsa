...
{
    /// <summary>reference from https://github.com/JeremyEspresso/MurmurHash</summary>
    public static class MurmurHash3
    {
        /// <summary>Hashes the <paramref name="bytes"/> into a MurmurHash3 as a <see cref="uint"/>.</summary>
